...
uint8_t SynthPatchStorageClass::bank[MAX_PATCHES][11] = {
    ...
    { 0, 0, 3, 0, 0, 64, 0, 0, 0, 0, 0 },
    { 0, 0, 4, 0, 0, 64, 0, 0, 0, 0, 0 },
    { 1, 0, 5, 0, 0, 64, 0, 0, 0, 0, 0 },
    { 92, 0, 6, 0, 0, 64, 0, 0, 0, 0, 0 },
    { 0, 7, 5, 0, 0, 64, 0, 0, 0, 0, 0 },
    { 0, 0, 0, 68, 0, 0, 0, 0, 40, 65, 63 },
    { 2, 0, 0, 68, 8, 0, 0, 99, 19, 65, 73 },
    { 0, 0, 7, 65, 0, 0, 0, 0, 0, 0, 127 }
};
#else
uint8_t SynthPatchStorageClass::bank[MAX_PATCHES][11] = {
    { 1, 0, 0, 0, 0, 64, 0, 0, 0, 0, 64 },
    ...
    { 2, 0, 0, 68, 8, 0, 0, 99, 19, 65, 73 },
    { 0, 0, 7, 65, 0, 0, 0, 0, 0, 0, 127 },
    { 0, 0, 0, 84, 0, 0, 0, 0,11,77, 71  },
    {27, 0, 5, 0,  0, 0, 0, 0,56,102,51},
    { 0, 0, 3, 0, 0, 0, 0, 0, 66,88,64},
    { 0, 0, 0,98, 0,106,8, 0, 0, 0, 0},
